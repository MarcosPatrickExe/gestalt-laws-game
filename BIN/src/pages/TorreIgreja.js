   ...
   constructor(){ 
       ...
       this.state = {
            ...
            pedacosMedalhao: {
                ...
                baixoEsq:      { left:  460+"px",  top: 590+"px"},
                cimaDir:       { left:  940+"px",  top: 370+"px"},
                cimaEsq:       { left:  570+"px",  top: 130+"px"},
                taca:          { left:  100+"px",  top: 100+"px"}
            },

            objetosCenario: {
                barril:        { left:   60+"px",  top: 410+"px"},
                caneca:        { left:  800+"px",  top: 300+"px"},
                escudoMesa:    { left:  380+"px",  top: 485+"px"},
                escudoParede:  { left:   50+"px",  top:  40+"px"},
                machado:       { left:  930+"px",  top: 230+"px"},
    ...
    dragend = (evt)=>{
        ...
        //console.log(JSON.stringify(objeto, null, 4));
...
function verficarMedalhao(estadoAtual){
   ...
   if(objetos.length==0) {
        ...
        console.log("classe: "+medalhao.className);
